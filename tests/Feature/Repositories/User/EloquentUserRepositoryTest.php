...
class EloquentUserRepositoryTest extends TestCase
{
     ...
     * @throws \Exception
     */
    public function test_user_repository_create_user()
    {
     ...
     * @throws \Exception
     */
    public function test_user_repository_find_by_id_user()
    {
     ...
     * @throws \Exception
     */
    public function test_user_repository_update_user()
    {
     ...
     * @throws \Exception
     */
    public function test_user_repository_delete_user()
    {
